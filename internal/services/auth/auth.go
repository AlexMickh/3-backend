...
type TokenService interface {
	CreateToken(ctx context.Context, userID int64, tokenType models.TokenType) (models.Token, error)
}
...
func (a *AuthService) Register(ctx context.Context, req dtos.RegisterDto) (int64, error) {
